        ...
        {blorpz.map((blorp, index) => {
          ...
          return (
            <div key={index}>
              ...
              <div id="poo">
                {poo === false ? null : (
                  <img src={"https://vignette.wikia.nocookie.net/tamagotchi/images/e/e2/Poop_large.png/revision/latest/scale-to-width-down/340?cb=20141219065412"} alt="poo" onClick={cleanPoo}/>
                )}
              </div>
            </div>
          );
